...
一、 用Idea打开项目，创建一个本地Git仓库,默认路径就选择该项目路径，此时项目的文件名会变红。
 ...
 ![step1.jpg](./assets/4_1.png)

 ![step2.jpg](./assets/4_2.png)

二、右键工程–>git–> Add 接着项目的文件名会变绿

 ![step3.jpg](./assets/4_3.png)

三、上传远程仓库
3.1
 ![1602811778(1).jpg](./assets/4_4.png)

3.2Commit和Push
 ![1602815072(1).jpg](./assets/4_5.png)
...
### 从远程服务器clone项目到本地
 ...
 ![1602817212(1).jpg](./assets/4_6.png)

### 更新项目编码到远程仓库

> 先add ->commit -> push

 ![1602827544(1).jpg](./assets/4_7.png)

 ![1602829404(1).jpg](./assets/4_8.png)
...
> Fetch和Pull，Fetch是从远程仓库下载文件到本地的origin/master，然后可以手动对比修改决定是否合并到本地的master库。Push则是直接下载并合并。如果各成员在工作中都执行修改前先更新的规范，则可以直接使用Pull方式以简化操作。
 ...
 ![1602829990(1).jpg](./assets/4_9.png)

### 创建分支 推送分支到远程仓库

> 新建分支

 ![1602831152(1).jpg](./assets/4_10.png)

 ![1602831212(1).jpg](./assets/4_11.png)

> 推送分支到远程仓库

 ![1602830962(1).jpg](./assets/4_12.png)

### 获取他人提交的分支

> 使用Pull功能打开更新窗口，点击Remote栏后面的刷新

 ![1602831380(1).jpg](./assets/4_13.png)

### 合并他人提交的分支到主干

 ![1602832449(1).jpg](./assets/4_14.png)
